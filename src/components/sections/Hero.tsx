...
import { navDelay, loaderDelay } from '../../lib/utils';
...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Joseph Kinyuru.</h2>;
  const three = <h3 className="big-heading">I build apps for the web.</h3>;
  const four = (
    <>
      <p>
